  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6">
        <div className="w-full max-w-md rounded-xl border border-rose-500/20 bg-rose-500/10 p-6 text-center">
          ...
          <p className="mt-4 text-xs text-slate-400">
            Check the console and <code className="rounded bg-slate-800 px-1">.env.local</code> for Firebase config.
          </p>
        </div>
      </body>
    </html>
